namespace Fabric.Terminology.SqlServer.Persistence.Mapping
{
    ...
    internal sealed class ValueSetShortCodeListFactory : ValueSetMapperBase, IModelFactory<ValueSetDescriptionDto, IValueSet>
    {
        ...
        public ValueSetShortCodeListFactory(
        ...
        public IValueSet Build(ValueSetDescriptionDto dto)
        {
            ...
            var cacheKey = CacheKeys.ValueSetBackingItemKey(dto.ValueSetGUID, this.codeSystemCds);
